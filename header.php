...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@300;400;500;600&family=Montserrat:wght@300;400;500;600&family=Raleway:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=935976649791078&ev=PageView&noscript=1" /></noscript>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=2766989046867023&ev=PageView&noscript=1" /></noscript>
    ...
    var ju_num = "8B388611-029F-400E-9E9C-6A4516BB7A7A";
    var asset_host = (("https:" == document.location.protocol) ? "https" : "http") + '://cdn.justuno.com/';
    (function() {
    ...
    window.ju_num = "8B388611-029F-400E-9E9C-6A4516BB7A7A";
    ...
    <script async src="https://tag.clearbitscripts.com/v1/pk_95703e3cec102b85ba9519123b03cb5a/tags.js"
                ...
                <div class="container-flued">
                    <div class="main-header-inner">
                        <div class="menu d-flex justify-content-between">
                            <div class="logo">
                                <div class="logo-icon">
                                    <a href="<?=get_full_url( '/' )?>" data-c="bluestout-logo"
                                        aria-label="bluestout-logo">
                                        <? if(is_front_page()) { ?>
                                        <div class="non-scrolled">
                                            <?get_template_part('assets/img/logo/logo-white');?>
                                        </div>
                                        <div class="scrolled">
                                            <?get_template_part('assets/img/logo/logo-dark');?>
                                        </div>
                                        <? } else { ?>
                                        <div class="">
                                            <?get_template_part('assets/img/logo/logo-dark');?>
                            ...
                            <nav class="nav-menu navbar navbar-expand-sm navbar-light">
                                <ul class="navbar-nav">
									...
									foreach($menu_list as $menu_index => $menu_item) {
										...
										?>
                                    <a href="<? echo $menu_link?>" class="nav-link smd-content <? echo $submenu ? "
                                        hover-toggle" : "" ?>" role="button">
                                    ...
                                    <div class="hover-menu">
                                        <ul class="hover-menu-content">
                                            ...
                                            <li>
                                                <a class="hover-item xs-content" <? echo
                                                    $submenu_item['submenu_new_tab'] ? 'target="blank"' : '' ?>
                                                    href="<?=get_full_url($submenu_item['submenu_link'])?>">
                                                    <div class="d-flex">
                                                        <div class="image"><img
                                                                src="<?=$submenu_item['submenu_icon']?>"></div>
                                                        <div class="content">
                                                            <p class="title smd-content">
                                                                <?=$submenu_item['submenu_title']?></p>
                                            ...
                                            <div class="trusted-text-wrapper text-center">
                                                <p class="trusted-text xsx-content">TRUSTED PARTER OF &nbsp; <img
                                                        src="<?=bloginfo('template_url');?>/assets/img/logo/logo-shopify-dark.png"
                                                        alt="Shopify"></p>
                                            </div>
                                            <? } ?>
                                        </ul>
								...
								?>
                                    <li class="hidden-xs nav-item btn-book-call dark-button-hover">
                                        <a href="<?=get_field('book_a_call_link', 'option')?>" target="blank"
                                            class="nav-link smd-content"> <?=get_field('book_a_call_text', 'option')?>
                                        </a>
                                    </li>
                                    <li class="mobile-menu-toggle d-sm-block d-md-none">
                                        <a href="javascript:;" class="nav-link smd-content menu-open icon-white"> <img
                                                src="<?=bloginfo( 'template_url' );?>/assets/img/menu-bar-white.svg"
                                                alt="=" /> </a>
                                        <a href="javascript:;" class="nav-link smd-content menu-close icon-white"> <img
                                                src="<?=bloginfo( 'template_url' );?>/assets/img/menu-close-white.svg"
                                                alt="=" /> </a>
                                        <a href="javascript:;" class="nav-link smd-content menu-open icon-dark"> <img
                                                src="<?=bloginfo( 'template_url' );?>/assets/img/menu-bar-dark.svg"
                                                alt="X" /> </a>
                                        <a href="javascript:;" class="nav-link smd-content menu-close icon-dark"> <img
                                                src="<?=bloginfo( 'template_url' );?>/assets/img/menu-close-dark.svg"
                                                alt="X" /> </a>
                                    </li>
                                </ul>
                            </nav>
                            <ul class="mobile-menu">
								...
								foreach($menu_list as $menu_index => $menu_item) {
									...
									?>
                                <a href="<?=($menu_link==''?'javascript:;':$menu_link)?>"
                                    class="smd-content"><?=$menu_item['menu_link_text']?></a>
                                <? if(isset($submenu)) { ?>
                                <div class="sub-menu">
                                    <ul class="sub-menu-content">
                                        <? foreach($submenu as $key => $submenu_item) { if($menu_index == 2 && strpos($submenu_item['submenu_link'], 'cro-winners') !== false) continue; ?>
                                        <li class="sub-menu-item">
                                            <a class="xs-content white-button-hover"
                                                href="<?=$submenu_item['submenu_link']?>">
                                                <div class="sub-menu-item-content d-flex">
                                                    <div class="image"><img src="<?=$submenu_item['submenu_icon']?>"
                                                            alt="menu logo"></div>
                                                    <div class="content">
                                                        <p class="title smd-content"><?=$submenu_item['submenu_title']?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </a>
